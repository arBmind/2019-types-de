...
<svg class="build" viewBox="0 0 1280 720" width="1920" height="1080">
    ...
    <g class="clientMonitor build" transform="translate(400,180)">
    ...
    <g class="command build" transform="translate(700,100)">
    ...
    <g class="events build" transform="translate(1100, 430)">
        <path class="commandArrow" style="filter:url(#dropshadow)"
            fill="#fca" stroke="#222" stroke-width="2"
            d="M-150,0
                c-1,-1.66 -.66,-5 1,-6
    ...
    <g class="compute build" transform="translate(825, 575)">
        ...
        <path class="ComputeSum"
            ...
            d="M-55,-65
                ...
                l45,45 l-40,40
                h45 c12,0 24,-4 32,-20 l4,-8 h7 l-12,50 h-98
    ...
    <g class="views build" transform="translate(200, 500)">
